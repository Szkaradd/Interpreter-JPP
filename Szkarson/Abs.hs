...
-- | The abstract syntax of language Szkarson.

module Szkarson.Abs where
...
data Decl' a
    = DDecl a (Type' a) [Item' a]
    | FnDecl a Ident [Arg' a] (Type' a) (Block' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Stmt' a
    ...
    | Ret a (Expr' a)
    | VRet a
    | SIf a (Expr' a) (Block' a) [ElseIf' a]
    | SIfElse a (Expr' a) (Block' a) [ElseIf' a] (Block' a)
...
type ElseIf = ElseIf' BNFC'Position
data ElseIf' a = ElIf a (Expr' a) (Block' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Type = Type' BNFC'Position
data Type' a = TInt a | TStr a | TBool a | TVoid a
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Expr = Expr' BNFC'Position
data Expr' a
    = EVar a Ident
    | EBuildInFun a Ident Ident [Expr' a]
    | EAddr a Ident
    | ELitInt a Integer
    | ELitTrue a
    | ELitFalse a
...
instance HasPosition ElseIf where
  hasPosition = \case
    ElIf p _ _ -> p
